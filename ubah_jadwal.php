...
include 'koneksi.php';
$kode = $_GET['kode'];
$result = mysqli_query($koneksi, "SELECT * FROM jadwalkuliah WHERE kode='$kode'");
while($user_data = mysqli_fetch_array($result))
{
$hari = $user_data['hari'];
$jam = $user_data['jam'];
$matakuliah = $user_data['matakuliah'];
$dosen = $user_data['dosen'];
$ruangan = $user_data['ruangan'];
$kode = $user_data['kode'];
}
?>
<!doctype html>
            ...
            <form action="update_jadwal.php" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="matakuliah" class="form-control" id="matakuliah" value=<?php echo $matakuliah;?>>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Ruangan</label>
                        <input type="text" name="ruangan" class="form-control" id="ruangan" value=<?php echo
                        $ruangan;?>>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Kode</label>
                        <input type="text" name="kode" class="form-control" id="kode" value=<?php echo
                        $kode;?>>
                    </div>
                </div>
