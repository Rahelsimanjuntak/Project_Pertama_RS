    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modalTambah"> <i
                    class="fas fa-plus-circle mr-2"></i>TAMBAH DATA PEGAWAI
            </button>
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td align="center">
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#modalEdit<?php echo $data['nik'];?>"> <i
                                class="fas fa-edit bg-success p-2 text-white rounded"></i>
                            Edit
                        </button>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#modalDelete<?php echo $data['nik'];?>"> <i
                ...
                <!-- Update Modal -->
                <div class="modal fade" id="modalEdit<?php echo $data['nik'];?>" tabindex="-1"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="update_pgw.php" method="post" role="form">
                                    <?php
                                            $nim = $data['nik'];
                                            $query1 = mysqli_query($koneksi, "SELECT * FROM pegawai WHERE nik='$nim'");
...
?>
    ...
    <!-- Modal Delete -->
    <div class="modal fade" id="modalDelete<?php echo $data['nik'];?>" tabindex="-1" aria-labelledby="modalDeleteLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <h5 align="center">Apakah anda yakin ingin menghapus NIM <?php echo $data['nik'];?><strong><span
                                class="grt"></span></strong> ?</h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <a href="hapus_pgw.php?nim=<?php echo $data['nik']; ?>" class="btn btn-primary">Delete</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <form action="simpan_pgw.php" method="post" role="form">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-3 control-label text-right">Nama Pegawai</label>
                                <div class="col-sm-8"><input type="text" class="form-control" name="nama" placeholder="Nama Pegawai" value=""></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
