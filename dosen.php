    ...
    <div class="row no-gutters mt-5">
        <div class="col-md-2 bg-info mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="jadwalkuliah.php"><i class="far fa-calendar-alt mr-2"></i>Jadwal Kuliah</a>
                    <hr class="bg-secondary">
                </li>
            </ul>
        </div>
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-chalkboard-teacher mr-2"></i> Daftar Dosen</h3>
            <hr>
            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modalTambah"> <i
                    class="fas fa-plus-circle mr-2"></i>TAMBAH DATA DOSEN
            </button>
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td align="center">
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#modalEdit<?php echo $data['nidn'];?>"> <i
                                class="fas fa-edit bg-success p-2 text-white rounded"></i>
                            Edit
                        </button>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#modalDelete<?php echo $data['nidn'];?>"> <i
                ...
                <!-- Update Modal -->
                <div class="modal fade" id="modalEdit<?php echo $data['nidn'];?>" tabindex="-1"
                    aria-labelledby="modalEditLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title fs-5" id="modalEditLabel">Edit Data Dosem</h3>
                            </div>
...
?>
    ...
    <!-- Modal Delete -->
    <div class="modal fade" id="modalDelete<?php echo $data['nidn'];?>" tabindex="-1" aria-labelledby="modalDeleteLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <h5 align="center">Apakah anda yakin ingin menghapus NIDN <?php echo $data['nidn'];?><strong><span
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="simpan_dsn.php" method="post" role="form">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-3 control-label text-right">Nama Dose</label>
                                <div class="col-sm-8"><input type="text" class="form-control" name="nama" placeholder="Nama Dosen" value=""></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
